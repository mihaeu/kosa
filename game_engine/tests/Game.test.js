...
let game;
const blackIndustrialPlayerId = new PlayerId_1.PlayerId(1);
const greenAgriculturalPlayerId = new PlayerId_1.PlayerId(2);
...
const blueInnovativePlayerId = new PlayerId_1.PlayerId(3);
...
const redPatrioticPlayerId = new PlayerId_1.PlayerId(4);
...
const yellowEngineeringPlayerId = new PlayerId_1.PlayerId(5);
...
const whiteMechanicalPlayerId = new PlayerId_1.PlayerId(6);
...
const purpleMilitantPlayerId = new PlayerId_1.PlayerId(7);
