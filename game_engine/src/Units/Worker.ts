...
export class Worker extends Unit {
    ...
    public static readonly WORKER_6 = new Worker("WORKER_6");
    public static readonly WORKER_7 = new Worker("WORKER_7");
    public static readonly WORKER_8 = new Worker("WORKER_8");
}
